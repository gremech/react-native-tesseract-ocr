...
//	private static String DATA_PATH = this.getReactApplicationContext().getFilesDir().getAbsolutePath() + File.separator;
    ...
    public RNTesseractOcrModule(ReactApplicationContext reactContext) {
        ...
        this.DATA_PATH = this.getReactApplicationContext().getFilesDir().getAbsolutePath() + File.separator;
